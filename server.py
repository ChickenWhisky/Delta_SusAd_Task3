...
def handle_client(conn, addr):
    ...
    conn.send("OK@Welcome to the File Server.".encode(FORMAT))             # Sends the user a welcome message

    conn.send("AUTH_CHECK@Please enter user info".encode(FORMAT))
    ...
    while True :
        ...
        if user_verification:
            ...
            conn.send("OK@Invalid Username or Password. Please enter valid credentials.")
